...
<button type="button" class="btnSave" onclick="location.href='/ex/notice/modify?bno=${bno }&title=${title}&content=${content}&writer=${writer}&regdate=sysdate&viewcnt=0'">저장</button>
