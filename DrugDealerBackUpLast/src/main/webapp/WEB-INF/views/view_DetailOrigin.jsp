                ...
                <div class="container px-5 my-5">
                    <div class="row gx-5 align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <br>
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" style="display: inline-block;">
                                <div class="text-center">
                                    <a class="btn btn-outline-dark mt-auto" href="#" style="width:150px">Order Now</a>     
                                    <form action="/ex/cart/insert" method="post">      
                                    <button class="btn btn-outline-dark mt-auto" style="width:150px">Add to Cart</button>
                                    </form>
                                    </div>
                            </div>
                        </div>
