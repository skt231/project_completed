...
<div class="d-grid">
	...
	<button type="submit" class="btnRemove" onclick="location.href='/ex/qna/remove?bno=${list_read.bno }'">삭제</button>
	<button type="button" class="btnReply" onclick="location.href='/ex/qna/reply?bno=${list_read.bno }&title=${list_read.title}&indent=${list_read.indent }&depthno=${list_read.depthno }'">답글</button>
