...
<body>
    <div class="wrap">
		...
		<table border="1" width="90%" id="Champion" style="color: white;">
			<tr>
				<th><a href="/TFTInfoSite/Main_Select/SelectFilterName.TFT?filter=name">name</a></th>
				<th><a href="/TFTInfoSite/Main_Select/SelectFilterName.TFT?filter=skill">skill</a></th>
				<th><a href="/TFTInfoSite/Main_Select/SelectFilterName.TFT?filter=price">cost</a></th>
				<th><a href="/TFTInfoSite/Main_Select/SelectFilterName.TFT?filter=synerge1">synerge1</a></th>
				<th><a href="/TFTInfoSite/Main_Select/SelectFilterName.TFT?filter=synerge2">synerge2</a></th>
				<th><a href="/TFTInfoSite/Main_Select/SelectFilterName.TFT?filter=synerge3">synerge3</a></th>
			</tr>
			<c:forEach items="${dtos }" var="ChampionSynergeDto">
				<tr>
					<td><center>${ChampionSynergeDto.name }</center></td>
					<td><center><a
						href="/TFTInfoSite/Main_Select/SelectOne.TFT?name=${ChampionSynergeDto.name}&
						skill=${ChampionSynergeDto.skill }">${ChampionSynergeDto.skill }</a></center></td>
					<td><center>${ChampionSynergeDto.price }</center></td>
		...
		<div id="sendman">
		<button onclick="location.href='/TFTInfoSite/Main_Select/Insert.TFT'" id="button_login">입력</button>
		<button onclick="location.href='/TFTInfoSite/Main_Select/list.member'" id="button_login">회원목록</button><br>	
			<div id="search">
			<form action="/TFTInfoSite/Main_Select/search.Servlet">
